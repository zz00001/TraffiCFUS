...
def parse_arguments(parser):
    ...
    parser.add_argument('--caption_rate', type=float, default=0.025, help='')
    ...
    parser.add_argument('--data_path', type=str, default='./weibo/', help='')
    parser.add_argument('--dataset_type', type=str, default='weibo', help='af: accident and fire; ds: dense and sparse')
    parser.add_argument('--input_path', type=str, default='./weibo/embedding_inputs/', help='')
    parser.add_argument('--output_path', type=str, default=output_file, help='')
    parser.add_argument('--remarks', type=str, default='text enhancement', help='备注')
    parser.add_argument('--need_tsne_data', type=bool, default=False, help='是否需要ts-SNE数据')
